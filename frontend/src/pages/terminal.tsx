...
const MOBILE_BANNER = [
  ...
  "${grn}║${rst}" + S(1) + "${bold}${ylw} +-+-+-+-+-+-+-+-+ +-+-+-+ ${rst}" + S(2) + "${grn}║${rst}",
  "${grn}║${rst}" + S(1) + "${bold}${ylw} |E|L|M|O|D|M|E|N| |V|P|S| ${rst}" + S(2) + "${grn}║${rst}",
  "${grn}║${rst}" + S(1) + "${bold}${ylw} +-+-+-+-+-+-+-+-+ +-+-+-+ ${rst}" + S(2) + "${grn}║${rst}",
  "${grn}║${rst}" + S(30) + "${grn}║${rst}",
  "${grn}║${rst}" + S(7) + "${dim}${g(245)}Isolated Sandbox${rst}" + S(7) + "${grn}║${rst}",
  "${grn}║${rst}" + S(5) + "${dim}${g(245)}Type ${rst}${ylw}$${rst}${dim}${g(245)} then commands${rst}" + S(5) + "${grn}║${rst}",
  "${grn}║${rst}" + S(30) + "${grn}║${rst}",
  "${grn}╚" + "═".repeat(30) + "╝${rst}",
  "",
  "${ylw}$ ${rst}",
